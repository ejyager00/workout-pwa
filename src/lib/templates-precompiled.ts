...
output += "\"\n      data-callback=\"onTurnstileSuccess\"\n    ></div>\n    <input type=\"hidden\" name=\"turnstileToken\" id=\"turnstileToken\" />\n\n    <button\n      type=\"submit\"\n      class=\"w-full bg-red-700 hover:bg-red-800 text-white font-medium py-2 px-4 rounded text-sm transition-colors\"\n    >\n      Log in\n    </button>\n  </form>\n\n  <p class=\"mt-4 text-sm text-gray-600 text-center\">\n    Don't have an account?\n    <a href=\"/auth/signup\" class=\"text-red-700 hover:underline\">Sign up</a>\n  </p>\n</div>\n\n<script src=\"https://challenges.cloudflare.com/turnstile/v0/api.js\" async defer></script>\n<script>\n  function onTurnstileSuccess(token) {\n    document.getElementById('turnstileToken').value = token;\n  }\n</script>\n";
cb(null, output);
;
} catch (e) {
  cb(runtime.handleError(e, lineno, colno));
...
output += "\"\n        class=\"w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500\"\n        placeholder=\"Note title\"\n      />\n    </div>\n\n    <div>\n      <label for=\"body\" class=\"block text-sm font-medium text-gray-700 mb-1\">\n        Body\n      </label>\n      <textarea\n        id=\"body\"\n        name=\"body\"\n        rows=\"10\"\n        maxlength=\"10000\"\n        class=\"w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 font-mono\"\n        placeholder=\"Write your note here...\"\n      >";
...
output += "</textarea>\n    </div>\n\n    <div class=\"flex items-center gap-3\">\n      <button\n        type=\"submit\"\n        class=\"bg-red-700 hover:bg-red-800 text-white font-medium py-2 px-4 rounded text-sm transition-colors\"\n      >\n        ";
...
try {
var frame = frame.push(true);
output += "\n<div class=\"max-w-2xl mx-auto\">\n  <div class=\"flex items-center justify-between mb-6\">\n    <h2 class=\"text-xl font-semibold\">My Notes</h2>\n    <a\n      href=\"/notes/new\"\n      class=\"bg-red-700 hover:bg-red-800 text-white text-sm font-medium py-2 px-4 rounded transition-colors\"\n    >\n      + New Note\n    </a>\n  </div>\n\n  ";
if(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "notes")),"length") === 0) {
output += "\n    <p class=\"text-gray-500 text-sm\">No notes yet. <a href=\"/notes/new\" class=\"text-red-700 hover:underline\">Create your first note.</a></p>\n  ";
;
}
else {
...
output += "\" class=\"text-sm font-medium text-gray-900 hover:text-red-700 truncate flex-1\">\n            ";
...
try {
var frame = frame.push(true);
output += "\n<div class=\"max-w-lg mx-auto space-y-8\">\n\n  <p class=\"text-sm text-gray-500\"><a href=\"/about#settings\" class=\"text-red-700 hover:underline\">What do these settings do?</a></p>\n\n  <!-- Appearance -->\n  <section>\n    <h2 class=\"text-base font-semibold text-gray-900 mb-3\">Appearance</h2>\n    <div class=\"border border-gray-200 rounded-lg p-4\">\n      ";
var tasks = [];
tasks.push(
function(callback) {
...
try {
var frame = frame.push(true);
output += "\n<div class=\"max-w-lg mx-auto\">\n\n  <div class=\"flex items-center justify-between mb-6\">\n    <h2 class=\"text-xl font-semibold\">Workout History</h2>\n    <a href=\"/workouts/new\"\n       class=\"text-sm text-red-700 hover:text-red-900 font-medium\">+ Log workout</a>\n  </div>\n\n  <div class=\"space-y-3\">\n    ";
var tasks = [];
tasks.push(
function(callback) {
...
output += "\" required\n               class=\"border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500\">\n      </div>\n      <div>\n        <label for=\"notes\" class=\"block text-sm font-medium text-gray-700 mb-1\">Notes <span class=\"text-gray-400 font-normal\">(optional)</span></label>\n        <textarea id=\"notes\" name=\"notes\" rows=\"2\" maxlength=\"2000\"\n                  placeholder=\"How'd it go?\"\n                  class=\"w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 resize-none\"></textarea>\n      </div>\n    </div>\n\n    <!-- Lifts -->\n    <div>\n      <h3 class=\"text-sm font-semibold text-gray-700 mb-3 uppercase tracking-wide\">Lifts</h3>\n      <div id=\"lifts-container\" class=\"space-y-4\"></div>\n      <button type=\"button\" id=\"add-lift-btn\"\n              class=\"mt-3 w-full border border-dashed border-gray-300 hover:border-red-500 text-gray-500 hover:text-red-700 rounded-lg py-3 text-sm font-medium transition-colors\">\n        + Add Lift\n      </button>\n    </div>\n\n    <button type=\"submit\"\n            class=\"w-full bg-red-700 hover:bg-red-800 text-white font-semibold py-3 px-4 rounded-lg text-sm transition-colors\">\n      Save Workout\n    </button>\n  </form>\n</div>\n\n<!-- Templates (not rendered, cloned by JS) -->\n<template id=\"lift-template\">\n  <div class=\"lift-section border border-gray-200 rounded-lg overflow-hidden\" data-lift-idx=\"\">\n    <div class=\"bg-gray-50 border-b border-gray-200 px-3 py-2 flex items-center gap-2\">\n      <input type=\"text\" name=\"lift_name[]\" placeholder=\"Lift name (e.g. Squat)\" required\n             maxlength=\"100\"\n             class=\"flex-1 bg-transparent text-sm font-medium text-gray-800 placeholder-gray-400 focus:outline-none min-w-0\">\n      <input type=\"hidden\" name=\"lift_superset[]\" value=\"\">\n      <button type=\"button\" class=\"remove-lift-btn text-gray-400 hover:text-red-500 text-lg leading-none flex-shrink-0\" title=\"Remove lift\">&times;</button>\n    </div>\n    <div class=\"p-3 space-y-2\">\n      <div class=\"sets-container space-y-2\"></div>\n      <button type=\"button\" class=\"add-set-btn text-xs text-red-700 hover:text-red-900 font-medium\">\n        + Add set\n      </button>\n    </div>\n  </div>\n</template>\n\n<template id=\"set-template\">\n  <div class=\"set-row flex items-center gap-2\">\n    <input type=\"hidden\" name=\"set_lift[]\" value=\"\">\n    <span class=\"set-label text-xs text-gray-400 w-6 flex-shrink-0 text-center font-medium\"></span>\n    <div class=\"flex items-center gap-1 flex-1\">\n      <input type=\"number\" name=\"set_reps[]\" placeholder=\"Reps\" required\n             min=\"0\" max=\"9999\"\n             class=\"w-full border border-gray-300 rounded px-2 py-1.5 text-sm text-center focus:outline-none focus:ring-1 focus:ring-red-500\">\n      <span class=\"text-gray-400 text-xs flex-shrink-0\">×</span>\n      <input type=\"number\" name=\"set_weight[]\" placeholder=\"lbs\" required\n             min=\"0\" max=\"9999\" step=\"0.5\"\n             class=\"w-full border border-gray-300 rounded px-2 py-1.5 text-sm text-center focus:outline-none focus:ring-1 focus:ring-red-500\">\n      <span class=\"text-gray-400 text-xs flex-shrink-0\">lbs</span>\n    </div>\n    <button type=\"button\" class=\"remove-set-btn text-gray-300 hover:text-red-500 flex-shrink-0 leading-none\"\n            title=\"Remove set\">&times;</button>\n  </div>\n</template>\n\n<script>\n  let liftCount = 0;\n\n  function addSet(liftSection) {\n    const liftIdx = parseInt(liftSection.dataset.liftIdx);\n    const container = liftSection.querySelector('.sets-container');\n    const setIdx = container.querySelectorAll('.set-row').length;\n\n    const tmpl = document.getElementById('set-template').content.cloneNode(true);\n    const row = tmpl.querySelector('.set-row');\n\n    row.querySelector('[name=\"set_lift[]\"]').value = liftIdx;\n    row.querySelector('.set-label').textContent = setIdx + 1;\n\n    row.querySelector('.remove-set-btn').addEventListener('click', () => {\n      if (container.querySelectorAll('.set-row').length > 1) {\n        row.remove();\n        renumberSets(container);\n      }\n    });\n\n    container.appendChild(tmpl);\n  }\n\n  function renumberSets(container) {\n    container.querySelectorAll('.set-label').forEach((el, i) => {\n      el.textContent = i + 1;\n    });\n  }\n\n  function addLift() {\n    const tmpl = document.getElementById('lift-template').content.cloneNode(true);\n    const section = tmpl.querySelector('.lift-section');\n    const idx = liftCount++;\n\n    section.dataset.liftIdx = idx;\n\n    section.querySelector('.remove-lift-btn').addEventListener('click', () => {\n      section.remove();\n    });\n\n    section.querySelector('.add-set-btn').addEventListener('click', () => {\n      addSet(section);\n    });\n\n    document.getElementById('lifts-container').appendChild(tmpl);\n\n    // Add an initial set and focus the lift name input\n    addSet(section);\n    section.querySelector('[name=\"lift_name[]\"]').focus();\n  }\n\n  document.getElementById('add-lift-btn').addEventListener('click', addLift);\n\n  // Start with one lift\n  addLift();\n</script>\n";
cb(null, output);
;
} catch (e) {
  cb(runtime.handleError(e, lineno, colno));
...
output += "\n<nav class=\"fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-40\"\n     style=\"padding-bottom: env(safe-area-inset-bottom, 0)\">\n  <div class=\"max-w-lg mx-auto grid grid-cols-5 h-14\">\n\n    <a href=\"/\" class=\"flex flex-col items-center justify-center gap-0.5 text-gray-500 hover:text-red-700 transition-colors\">\n      <svg class=\"w-5 h-5\" width=\"20\" height=\"20\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.75\" viewBox=\"0 0 24 24\">\n        <path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6\"/>\n      </svg>\n      <span class=\"text-xs font-medium\">Home</span>\n    </a>\n\n    <a href=\"/routines\" class=\"flex flex-col items-center justify-center gap-0.5 text-gray-500 hover:text-red-700 transition-colors\">\n      <svg class=\"w-5 h-5\" width=\"20\" height=\"20\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.75\" viewBox=\"0 0 24 24\">\n        <path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z\"/>\n      </svg>\n      <span class=\"text-xs font-medium\">Routines</span>\n    </a>\n\n    <a href=\"/workouts/new\" class=\"flex flex-col items-center justify-center gap-0.5 text-gray-500 hover:text-red-700 transition-colors\">\n      <span class=\"flex items-center justify-center w-9 h-9 bg-red-700 hover:bg-red-800 rounded-full transition-colors -mt-4 shadow-md\">\n        <svg class=\"w-5 h-5 text-white\" width=\"20\" height=\"20\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2.5\" viewBox=\"0 0 24 24\">\n          <path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M12 4v16m8-8H4\"/>\n        </svg>\n      </span>\n      <span class=\"text-xs font-medium -mt-0.5\">Log</span>\n    </a>\n\n    <a href=\"/workouts\" class=\"flex flex-col items-center justify-center gap-0.5 text-gray-500 hover:text-red-700 transition-colors\">\n      <svg class=\"w-5 h-5\" width=\"20\" height=\"20\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.75\" viewBox=\"0 0 24 24\">\n        <path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01\"/>\n      </svg>\n      <span class=\"text-xs font-medium\">History</span>\n    </a>\n\n    <a href=\"/settings\" class=\"flex flex-col items-center justify-center gap-0.5 text-gray-500 hover:text-red-700 transition-colors\">\n      <svg class=\"w-5 h-5\" width=\"20\" height=\"20\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.75\" viewBox=\"0 0 24 24\">\n        <path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z\"/><circle cx=\"12\" cy=\"12\" r=\"3\"/>\n      </svg>\n      <span class=\"text-xs font-medium\">Settings</span>\n    </a>\n\n  </div>\n</nav>\n";
;
}
output += "\n";
if(parentTemplate) {
...
output += " text-center text-sm text-gray-500 space-y-2\">\n  <p><a href=\"/about\" class=\"text-red-700 hover:text-red-800 hover:underline\">About &amp; Disclaimers</a></p>\n  <p>&copy; ";
...
output += " Lift Log. <a href=\"https://github.com/ejyager00/workout-pwa\" class=\"text-red-700 hover:text-red-800 hover:underline\">Open source.</a> Built with <a href=\"https://github.com/ejyager00/htmx-crud-worker-template\">Cloudflare Workers</a>.</p>\n</footer>\n";
if(parentTemplate) {
parentTemplate.rootRenderFunc(env, context, frame, runtime, cb);
} else {
cb(null, output);
...
output += "\n        <a href=\"/auth/login\" class=\"text-gray-700 hover:underline\">Log in</a>\n        <a href=\"/auth/signup\" class=\"text-red-700 hover:underline font-medium\">Sign up</a>\n      ";
;
}
output += "\n    </div>\n  </div>\n</nav>\n";
if(parentTemplate) {
...
output += runtime.suppressValue(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "item")),"lift_name"), env.opts.autoescape);
output += "\"\n                       placeholder=\"Lift name\" required maxlength=\"100\"\n                       class=\"flex-1 min-w-32 border border-gray-300 rounded px-2 py-1 text-sm focus:outline-none focus:ring-1 focus:ring-red-500\">\n                <div class=\"flex items-center gap-1 flex-shrink-0\">\n                  <input type=\"number\" name=\"reps_min\" value=\"";
output += runtime.suppressValue(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "item")),"reps_min"), env.opts.autoescape);
output += "\"\n                         min=\"1\" max=\"999\" required\n                         class=\"w-14 border border-gray-300 rounded px-2 py-1 text-sm text-center focus:outline-none focus:ring-1 focus:ring-red-500\">\n                  <span class=\"text-gray-400 text-xs\">–</span>\n                  <input type=\"number\" name=\"reps_max\" value=\"";
output += runtime.suppressValue(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "item")),"reps_max"), env.opts.autoescape);
...
output += "\"\n                           placeholder=\"Lift name\" required maxlength=\"100\"\n                           class=\"flex-1 min-w-32 border border-red-200 rounded px-2 py-1 text-sm focus:outline-none focus:ring-1 focus:ring-red-500 bg-white\">\n                    <div class=\"flex items-center gap-1 flex-shrink-0\">\n                      <input type=\"number\" name=\"reps_min\" value=\"";
output += runtime.suppressValue(runtime.memberLookup((t_9),"reps_min"), env.opts.autoescape);
output += "\"\n                             min=\"1\" max=\"999\" required\n                             class=\"w-14 border border-red-200 rounded px-2 py-1 text-sm text-center focus:outline-none focus:ring-1 focus:ring-red-500 bg-white\">\n                      <span class=\"text-gray-400 text-xs\">–</span>\n                      <input type=\"number\" name=\"reps_max\" value=\"";
...
output += runtime.suppressValue(runtime.contextOrFrameLookup(context, frame, "csrfToken"), env.opts.autoescape);
output += "\">\n      <div class=\"flex gap-2\">\n        <input type=\"text\" name=\"name\" placeholder=\"Key name (e.g. Garmin sync)\"\n               required maxlength=\"80\"\n               class=\"flex-1 min-w-0 border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500\">\n        <button type=\"submit\"\n                class=\"flex-shrink-0 bg-red-700 hover:bg-red-800 text-white text-sm font-medium py-2 px-3 rounded transition-colors\">\n          Create\n        </button>\n      </div>\n    </form>\n  </div>\n\n</div>\n";
if(parentTemplate) {
parentTemplate.rootRenderFunc(env, context, frame, runtime, cb);
} else {
cb(null, output);
...
output += runtime.suppressValue((runtime.contextOrFrameLookup(context, frame, "darkMode")?"bg-red-700":"bg-gray-200"), env.opts.autoescape);
...
output += runtime.suppressValue(runtime.contextOrFrameLookup(context, frame, "csrfToken"), env.opts.autoescape);
output += "\">\n    <button type=\"submit\"\n            class=\"relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 ";
output += runtime.suppressValue((runtime.contextOrFrameLookup(context, frame, "inlineLogging")?"bg-red-700":"bg-gray-200"), env.opts.autoescape);
output += "\"\n            role=\"switch\" aria-checked=\"";
...
output += "\n      <div class=\"border border-red-100 rounded-lg overflow-hidden\">\n        <div class=\"bg-red-50 px-3 py-1.5\">\n          <span class=\"text-xs font-semibold text-red-700 uppercase tracking-wide\">Superset</span>\n        </div>\n        ";
frame = frame.push();
...
output += "\n          <div class=\"px-3 py-2 ";
if(!runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "loop")),"last")) {
output += "border-b border-red-100";
;
}
...
output += "</p>\n    </div>\n    <div class=\"flex items-center gap-2 flex-shrink-0\">\n      <a href=\"/workouts/";
output += runtime.suppressValue(runtime.memberLookup((t_4),"id"), env.opts.autoescape);
output += "/edit\"\n         class=\"text-xs text-red-700 hover:text-red-900 font-medium\">Edit</a>\n      <button type=\"button\"\n              hx-get=\"/workouts/";
output += runtime.suppressValue(runtime.memberLookup((t_4),"id"), env.opts.autoescape);
output += "/detail\"\n              hx-target=\"#detail-";
output += runtime.suppressValue(runtime.memberLookup((t_4),"id"), env.opts.autoescape);
...
output += "\"\n     hx-target=\"this\"\n     hx-swap=\"outerHTML\"\n     hx-trigger=\"click\"\n     class=\"w-full text-center py-3 text-sm text-red-700 hover:text-red-900 font-medium border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors\">\n  Load more\n</div>\n";
;
}
output += "\n";
if(parentTemplate) {
